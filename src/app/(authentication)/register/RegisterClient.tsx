...
export default function RegisterPage() {
  ...
  return (
    <div className="container relative flex-col items-center justify-center grid lg:max-w-none lg:grid-cols-2 lg:px-0 min-h-screen overflow-hidden selection:bg-indigo-500/30">
          ...
          >
            ...
            <blockquote className="space-y-4">
              <p className="text-lg font-light text-zinc-400 leading-relaxed">
                Connect with the best minds in IT. Start your journey today and
                build something extraordinary with Rangdhanu IT.
              </p>
      ...
      <div className="relative lg:p-8 flex items-center justify-center min-h-screen py-12">
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[480px] px-6">
          <motion.div
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <div className="relative group/input">
                        <UserIcon className="absolute left-3.5 top-3.5 h-4 w-4 text-zinc-600 transition-colors group-focus-within/input:text-indigo-500" />
                        <Input
                          id="name"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group/input">
                        <Phone className="absolute left-3.5 top-3.5 h-4 w-4 text-zinc-600 transition-colors group-focus-within/input:text-indigo-500" />
                        <Input
                          id="contactNo"
                          placeholder="+88017..."
                          className="pl-11 h-12 bg-zinc-900/50 border-zinc-800/50 hover:border-zinc-700/50 focus:border-indigo-500/50 transition-all rounded-xl placeholder:text-zinc-700"
