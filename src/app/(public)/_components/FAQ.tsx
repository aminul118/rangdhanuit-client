          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                <span
                  className={`text-xl font-black tracking-tight transition-colors ${openIndex === index ? "text-primary" : "text-foreground"}`}
                >
                  {faq.question}
                </span>
                <div
                  className={`p-2 rounded-xl transition-all duration-500 ${openIndex === index ? "bg-primary text-primary-foreground rotate-180" : "bg-muted text-muted-foreground"}`}
                >
