import { ThemeSettings } from "@/app/(public)/(user-dashboard)/settings/appearance/_components/ThemeSettings";
import { Palette } from "lucide-react";
import { Metadata } from "next";

export const metadata: Metadata = {
  title: "Appearance Settings | Rangdhanu IT",
  description: "Personalize your dashboard experience with themes and colors.",
};
