    ...
    <main className="min-h-screen pb-32">
      ...
      <section className="relative h-[70vh] w-full overflow-hidden flex items-center justify-center pt-24">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-linear-to-b from-zinc-950/80 via-zinc-950/60 to-zinc-950" />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center space-y-8">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-zinc-400 text-lg md:text-2xl max-w-[700px] mx-auto leading-relaxed italic font-medium">
                &quot;{service.description}&quot;
              </p>
            </div>
          </div>
        ...
        <div className="absolute bottom-0 left-0 w-full h-32 bg-linear-to-t from-zinc-950 to-transparent" />
      </section>
      ...
      <section className="container mx-auto px-6 -mt-12 relative z-20">
        <div className="grid gap-16 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-12">
            <div className="glass-premium p-8 md:p-16 rounded-[4rem] border border-white/5 bg-zinc-900/20 backdrop-blur-3xl shadow-2xl">
              ...
              <HtmlContent
                className="prose prose-invert prose-lg md:prose-xl max-w-none prose-indigo prose-headings:font-black prose-headings:tracking-tighter prose-headings:text-white prose-p:text-zinc-400 prose-p:leading-relaxed prose-img:rounded-[2.5rem] prose-img:shadow-2xl prose-strong:text-indigo-400 prose-blockquote:border-indigo-500 prose-blockquote:bg-indigo-500/5 prose-blockquote:p-10 prose-blockquote:rounded-[2.5rem]"
          ...
          <aside className="space-y-8">
            <div className="glass-premium p-8 rounded-[3.5rem] border border-white/5 bg-zinc-900/40 backdrop-blur-xl">
