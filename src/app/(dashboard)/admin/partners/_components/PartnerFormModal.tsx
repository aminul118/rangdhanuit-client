  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="w-[95vw] max-w-lg flex flex-col overflow-hidden bg-background/95 backdrop-blur-3xl border-white/5 rounded-2xl p-0 shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] border"
      >
        <div className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar max-h-[85vh]">
          <div className="bg-linear-to-br from-primary via-primary/80 to-primary/60 p-6 sm:p-8 text-primary-foreground relative overflow-hidden">
            ...
            <DialogHeader className="relative z-10">
              ...
              <DialogDescription className="text-primary-foreground/70 text-xs mt-2 font-medium uppercase tracking-[0.2em] max-w-md">
                {isEdit
