      ...
      <div className="absolute top-0 left-[-9999px]">
        ...
        >
          ...
          <div
            ...
            className="h-[140px] px-16 flex justify-between items-center relative"
          >
            <div className="flex flex-col">
              <h1 className="text-white text-4xl font-black tracking-tighter m-0 uppercase">
                Service Quotation
              </h1>
              <p className="text-indigo-200 text-xs font-bold uppercase tracking-[0.3em] mt-2">
                Strategic Project Agreement
              </p>
            </div>
          ...
          <div className="p-16">
            ...
            <div
              ...
              className="mb-12 p-8 rounded-[2rem] border border-[#B0CFE0] italic text-slate-600 text-sm leading-loose relative overflow-hidden"
            >
              ...
              <p className="mb-4 relative z-10">
                ...
                <span className="font-bold text-slate-900 underline decoration-[#B0CFE0] decoration-2">
                  {format(new Date(), "do")}
                </span>{" "}
                day of{" "}
                <span className="font-bold text-slate-900 underline decoration-[#B0CFE0] decoration-2">
              ...
              <div className="grid grid-cols-[auto_1fr] gap-4 mb-4 relative z-10">
                <span
                  ...
                  className="font-black uppercase text-[10px] mt-1 tracking-widest"
                >
                  Provider
                </span>
                <p>
                  <strong className="text-slate-900 leading-none">
                    Rangdhanu IT
                  </strong>
                  , an elite software development firm specializing in bespoke
                  digital solutions, headquartered in Dhaka, Bangladesh.
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-12 mb-12">
              <div
                className="col-span-2 border-l-[6px] pl-8 py-2"
              ...
              >
                ...
                <h3 className="text-3xl font-black text-slate-900 tracking-tight">
                  {data.projectName || "Conceptual Project"}
                </h3>
              </div>
              ...
              <div className="space-y-8">
                <section>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed font-medium">
                    {data.description ||
                      "Project scope definition pending final review."}
                  </p>
                </section>
                <section>
                  <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">
                  ...
                  <div className="flex gap-12 text-sm">
                    <div className="flex flex-col">
                      ...
                      <span className="font-black text-slate-800 mt-1">
                        {data.startDate
              ...
              <div
                style={{ backgroundColor: DARK_BLUE }}
                className="text-white p-10 rounded-[2.5rem] shadow-xl shadow-indigo-100/50"
              >
                <h4 className="text-[10px] font-black text-indigo-300 uppercase tracking-widest mb-6 border-b border-white/10 pb-4">
                  Core Deliverables
                </h4>
                <ul className="space-y-4">
                  {(data.deliverables || "Core system components")
                    .split(",")
                    .map((item, i) => (
                      <li
                        key={i}
                        className="text-xs flex gap-4 font-medium opacity-90 items-start"
                      >
                        <span className="text-indigo-400 font-black mt-0.5">
                          ❯
                        </span>
                        <span>{item.trim()}</span>
                      </li>
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-4 gap-6">
                <div
                  style={{ backgroundColor: DARK_BLUE }}
                  className="col-span-2 p-10 rounded-[2.5rem] text-white shadow-2xl shadow-indigo-900/20"
                >
                ...
                <div
                  ...
                  className="p-8 rounded-[2.5rem] border border-slate-100 flex flex-col justify-center items-center text-center"
                >
                ...
                <div
                  style={{ backgroundColor: ROW_BLUE }}
                  className="p-8 rounded-[2.5rem] border border-[#B0CFE0] flex flex-col justify-center items-center text-center"
                >
                  <span
                    style={{ color: DARK_BLUE }}
              ...
              <div className="mt-8 flex flex-wrap gap-x-12 gap-y-4 px-6 text-[10px] font-black text-slate-400 uppercase tracking-widest border-t border-slate-50 pt-8">
                ...
                <span className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-400" />{" "}
                  Revisions: {data.revisions} Rounds
                </span>
                <span className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-400" />{" "}
                  Priority Support: {data.supportDays} Days
                </span>
              </div>
            </div>
            ...
            <div className="absolute right-12 bottom-48">
              ...
              >
                ...
                <div
                  ...
                  className="h-1.5 w-full mt-2 rounded-full opacity-30"
                />
                <span className="text-[10px] tracking-[0.4em] font-black mt-2 opacity-60 uppercase">
            ...
            <div className="grid grid-cols-2 gap-16 text-[11px] text-slate-400 mb-20 leading-relaxed border-t border-slate-50 pt-16">
              <section>
                ...
                <p>
                  Full digital assets and source code ownership transfer to the
                  client upon 100% financial settlement. Rangdhanu IT retains
                  the right to use non-sensitive architectural highlights for
              ...
              <section>
                ...
                <p>
                  Work commenced implies non-refundable initial strategic
                  investment. Termination requires 7 days notice. Mutual respect
                  and agile collaboration are prioritized throughout the
                  execution lifecycle.
                </p>
              </section>
            </div>
            ...
            <div className="mt-auto pt-16 border-t-[3px] border-slate-50 grid grid-cols-2 gap-40">
              <div className="text-center">
                ...
                <p
                  style={{ color: DARK_BLUE }}
                  className="text-xs font-black text-center uppercase tracking-[0.3em]"
                >
                  Rangdhanu IT
                </p>
                <p className="text-[10px] text-slate-400 text-center mt-2 font-bold tracking-widest uppercase">
                  Service Provider
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-xs font-black text-slate-900 text-center uppercase tracking-[0.3em]">
                  {data.clientName || "Client Representative"}
                </p>
                <p className="text-[10px] text-slate-400 text-center mt-2 font-bold tracking-widest uppercase">
