...
import { commentPlugin } from "@/components/rich-text/kits/comment-kit";
import {
  type TDiscussion,
  discussionPlugin,
} from "@/components/rich-text/kits/discussion-kit";
import { suggestionPlugin } from "@/components/rich-text/kits/suggestion-kit";
