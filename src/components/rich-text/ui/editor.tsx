  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        default:
          'min-h-full w-full px-16 pt-4 pb-32 text-base sm:px-[max(64px,calc(50%-350px))]',
        demo: 'min-h-full w-full px-16 pt-4 pb-32 text-base sm:px-[max(64px,calc(50%-350px))]',
        fullWidth: 'min-h-full w-full px-16 pt-4 pb-32 text-base sm:px-24',
        none: '',
