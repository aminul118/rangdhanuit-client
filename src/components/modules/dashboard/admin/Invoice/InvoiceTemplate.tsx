        ...
        >
          ...
          <div className="p-12">
            ...
            <div
              ...
              className="mt-20 p-8 rounded-[2.5rem] border border-[#B0CFE0] relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-24 h-24 bg-white/40 blur-3xl -mr-12 -mt-12" />
              <h3
                style={{ color: DARK_BLUE }}
                className="text-xs font-black uppercase tracking-[0.3em] mb-6 flex items-center gap-3"
              >
                <div
              ...
              <div className="grid grid-cols-2 gap-12 relative">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1 text-sm font-medium">
                    <p className="flex justify-between pr-8 text-slate-500">
                      Number:{" "}
