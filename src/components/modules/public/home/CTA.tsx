        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            >
              ...
              <span className="tracking-widest uppercase text-[10px]">Your Success, Our Mission</span>
            </motion.div>
            ...
            >
              Let&apos;s Build Your <span className="text-transparent bg-clip-text bg-linear-to-r from-violet-200 via-white to-violet-100 drop-shadow-sm">Digital Future</span> Together.
            </motion.h2>
            ...
            >
              Transform your business with cutting-edge solutions. Contact us for a free consultation and let&apos;s build something extraordinary.
            </motion.p>
