            ...
            return (
              ...
              >
                ...
                <div className="h-full border border-border/50 p-10 rounded-[2.5rem] glass backdrop-blur-xl flex flex-col items-start hover:border-primary/30 transition-all duration-500 overflow-hidden">
                  ...
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-8 shadow-2xl group-hover:scale-110 transition-transform duration-500 bg-primary/10 text-primary">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 font-bold text-sm tracking-wider uppercase group/link text-foreground"
                  >
                    <span className="relative overflow-hidden inline-block">
                      <span className="inline-block transition-transform duration-300 group-hover/link:-translate-y-full">
                        Explore Service
                      </span>
                      <span className="absolute top-0 left-0 inline-block transition-transform duration-300 translate-y-full group-hover/link:translate-y-0 text-primary">
                        Explore Service
                      </span>
                    </span>
