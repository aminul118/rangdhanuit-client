    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          <Button
            variant="ghost"
            size="icon"
            className="relative rounded-full w-10 h-10 border border-border/50 bg-background/50 backdrop-blur-sm shadow-sm hover:bg-accent transition-all group"
          >
            <Bell
              size={20}
              className={cn(
      ...
      >
        ...
        <Link href="/dashboard/notifications" className="block">
          <Button
            variant="ghost"
            className="w-full h-11 rounded-none text-xs font-bold text-muted-foreground hover:text-indigo-500 hover:bg-white/5 transition-colors uppercase tracking-widest"
          >
            View All History
          </Button>
        </Link>
