    ...
    <div className="relative grid lg:max-w-none lg:grid-cols-2 h-screen overflow-hidden selection:bg-indigo-500/30">
      ...
      <div className="sticky top-0 h-screen hidden flex-col bg-background p-10 text-foreground lg:flex border-r border-border/50">
        <div className="absolute inset-0 bg-linear-to-b from-muted/30 via-background to-background overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_2px_2px,hsla(var(--primary),0.05)_1px,transparent_0)] bg-size-[32px_32px]" />
          <AnimatedGradientBg />
        </div>

        <div className="relative z-20 flex items-center text-lg font-medium">
          <Link href="/" className="flex items-center gap-3 group">
            <Logo className="w-12 h-12 relative shadow-[0_0_20px_rgba(var(--primary),0.4)]" />
          </Link>
        </div>
          ...
          <FadeInLeft className="space-y-6">
            <div className="space-y-2">
              ...
              <h2 className="text-4xl font-bold tracking-tight text-foreground">
                {quoteTitle} <br />
                <span className="bg-linear-to-r from-primary to-purple-500 bg-clip-text text-transparent underline underline-offset-8 decoration-primary/30">
                  {quoteHighlight}
                </span>
              </h2>
            </div>
            <blockquote className="space-y-4">
              ...
              <footer className="flex items-center gap-2 text-primary font-medium tracking-wide">
      ...
      <div className="relative overflow-y-auto h-screen flex flex-col bg-background lg:bg-transparent">
        ...
        >
          <FadeInScale delay={0.1}>
            <Card className="border-border/50 bg-card/40 backdrop-blur-2xl shadow-2xl shadow-primary/5 overflow-hidden relative group">
              <div className="absolute top-0 left-0 w-full h-[2px] bg-linear-to-r from-transparent via-primary to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-1000" />

              <CardHeader className={headerClassName}>
                {headerIcon && (
                  <FadeInScale
                    delay={0.2}
                    className="mx-auto w-16 h-16 bg-linear-to-br from-primary/10 to-purple-500/10 rounded-2xl flex items-center justify-center mb-6 ring-1 ring-primary/20 shadow-inner"
                  >
                    {headerIcon}
                  </FadeInScale>
                )}
              ...
              <CardFooter className="flex flex-col space-y-4 border-t border-border/50 pt-5 mt-4 bg-muted/20">
                <div className="text-sm text-center text-muted-foreground font-medium">
                  ...
                  <Link
                    ...
                    className="text-primary hover:text-primary/80 font-bold transition-colors flex items-center justify-center gap-1 mt-1 group/link"
                  >
                    {footerLinkLabel}
