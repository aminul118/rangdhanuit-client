    ...
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 mb-16 px-2">
      <div className="space-y-4">
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <h1 className="text-3xl md:text-5xl font-black tracking-tight text-white flex items-center gap-6">
            {title}
      ...
      >
        <div className="px-8 py-5 rounded-[2rem] bg-indigo-500/5 border border-indigo-500/10 backdrop-blur-xl shadow-2xl relative group overflow-hidden">
          <div className="absolute inset-0 bg-linear-to-br from-indigo-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
          <p className="text-[11px] font-black uppercase tracking-[0.3em] text-indigo-400 relative z-10">
            Suite Mode Active
          </p>
        </div>
      </motion.div>
