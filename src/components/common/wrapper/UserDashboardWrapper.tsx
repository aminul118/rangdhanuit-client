        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          >
            <div>
              ...
              <p className="mt-4 text-muted-foreground text-lg max-w-lg leading-relaxed">
                Your portal to premium IT services and real-time support. How can we help you today?
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Connect instantly with our admin team. Get responses within minutes for your technical queries.
                </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Browse our range of professional portfolios and project case studies curated just for you.
                </p>
                <Link href="/admin/portfolios">
                  <Button variant="outline" className="w-full rounded-2xl h-12 border-white/10 hover:bg-white/5 group/btn">
                    View Portfolios
                    <ExternalLink size={18} className="ml-2 opacity-50 group-hover/btn:opacity-100 transition-opacity" />
                  </Button>
                </Link>
              </div>
            </motion.div>
          ...
          >
            <div className="flex items-center justify-between mb-8">
              <h4 className="text-sm font-black uppercase tracking-[0.2em] text-muted-foreground">Recent Activity</h4>
