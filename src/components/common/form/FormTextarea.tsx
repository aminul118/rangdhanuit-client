...
/* =================================================
   FormTextarea — reusable labeled textarea with
   optional icon and animated error message
   ================================================= */

interface FormTextareaProps extends React.ComponentProps<"textarea"> {
  /** Label text shown above the textarea */
  label: string;
  /** Unique id for the textarea (also tied to label htmlFor) */
  id: string;
  /** Optional icon rendered on the top-left inside the textarea */
  icon?: ReactNode;
