    ...
    <div className={cn("flex items-center gap-2.5", className)}>
      ...
      {showText && (
        ...
        >
          ...
          <span className="ml-1 text-violet-600 dark:text-violet-400 font-black relative flex items-center">
            IT
            <span className="absolute -bottom-1 left-0 w-full h-0.5 bg-violet-600 dark:bg-violet-400 rounded-full origin-left scale-x-0 group-hover:scale-x-100 transition-all duration-300 shadow-sm" />
          </span>
        </span>
      )}
    </div>
